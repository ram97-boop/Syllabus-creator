...
public class ExaminationControllerTest {
    ...
    private void setUpThreeGradingScales() {
        ...
        gradingScales.get(0).setSelectedItem(GradingScale.getLongGradingScaleStrings()[1]); // ACTUALLY: G-U (VG-U)
        gradingScales.get(1).setSelectedItem(GradingScale.getLongGradingScaleStrings()[0]); // A-F
        gradingScales.get(2).setSelectedItem(GradingScale.getLongGradingScaleStrings()[2]); // ACTUALLY: VG-U (G-U)
    }

    private void setUpFiveGradingScales() {
        ArrayList<JComboBox<String>> gradingScales = panel.getGradingScales();
        gradingScales.get(0).setSelectedItem(GradingScale.getLongGradingScaleStrings()[1]); // ACTUALLY: G-U (VG-U)
        gradingScales.get(1).setSelectedItem(GradingScale.getLongGradingScaleStrings()[2]); // ACTUALLY: VG-U (G-U)
        gradingScales.get(2).setSelectedItem(GradingScale.getLongGradingScaleStrings()[1]); // ACTUALLY: G-U (VG-U)
        gradingScales.get(3).setSelectedItem(GradingScale.getLongGradingScaleStrings()[2]); // ACTUALLY: VG-U (G-U)
